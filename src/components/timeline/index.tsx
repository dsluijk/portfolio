  ...
  return (
    <section class={style.wrapper}>
      ...
      <div class={style.timeline}>
        ...
        >
          After winning a competition at a course at my university, I was
          invited to join some projects at the Distributed Systems group from
          the Delft University of Technology. Now I do research on protecting
          distributed systems from Sybil attacks.
        </TimeEntry>
        <TimeEntry
        ...
        >
          This is my current major, where I'm currently doing the Systems
          variant. In the first year I won a competition by creating the fastest
          JIT compiler for Brainfuck in Assembly of my year. It ran Towers of
          Hanoi in 60ms on average. This lead to some extracurricular activities
          at Tribler.
        </TimeEntry>
        <TimeEntry
        ...
        >
          To be admitted to the Delft University of Technology I had to
          eliminate a deficiency in mathematics. This certificate would proof
          that my math was on a sufficient level to start the year. I passed the
          exam with a 7.
        </TimeEntry>
        <TimeEntry
        ...
        >
          ...
          Honours track. Despite that I didn't feel like I was being challenged
          at this University, so at the start of the second year I left to
          pursue a slightly related Bachelor at the Delft University of
          Technology.
        </TimeEntry>
      </div>
    </section>
